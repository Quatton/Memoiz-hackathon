...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="max-w-lg py-16 mx-auto flex min-h-screen w-full flex-col items-center justify-center gap-6">
        ...
        <div className="w-80 rounded-md bg-slate-50 py-16">
          {chat.map((x, idx) => {
            return (
              <div
                key={idx}
