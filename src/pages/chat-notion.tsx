...
const ChatNotionPage: NextPage = () => {
  ...
  return (
    <Container>
      ...
      <Nav />
      <main className="flex h-full w-full max-w-lg flex-1 flex-col items-center justify-center px-5 pb-16 pt-12">
        <div className="mb-2 flex w-full items-center justify-center gap-2 rounded-xl text-sm sm:text-base">
          <MdWarning />
              ...
              <div className={`chat chat-start`}>
                <div className="chat-bubble">
                  <div className="flex items-center gap-2">
                    ...
                    <MdRefresh
                      size={22}
                      className="text-white hover:cursor-pointer hover:text-base"
                      onClick={() => {
                        mutation.reset();
                        setLoading(true);
                        mutation.mutate({
